...
{
    public class CreateExternalUserCommandHandler : IRequestHandler<CreateExternalUserCommand, UserDto>
    {
        ...
        public async Task<UserDto> Handle(CreateExternalUserCommand request, CancellationToken cancellationToken)
        {
